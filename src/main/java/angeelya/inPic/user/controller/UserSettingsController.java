...
public class UserSettingsController {
    ...
    public ResponseEntity<MessageResponse> updateEmail(@RequestBody @Valid EmailUpdateRequest updateRequest, BindingResult bindingResult) throws ValidationErrorsException, DatabaseNotFoundException, NoAddDatabaseException {
    ...
    public ResponseEntity<MessageResponse> updateName(@RequestBody @Valid NameUpdateRequest updateRequest, BindingResult bindingResult) throws ValidationErrorsException, DatabaseNotFoundException, NoAddDatabaseException {
        validationErrorsService.validation(bindingResult);
        return ResponseEntity.ok(new MessageResponse(userSettingsService.updateName(updateRequest)));
    }

    @PostMapping("/update/description")
    public ResponseEntity<MessageResponse> updateDescription(@RequestBody @Valid DescriptionUpdateRequest descriptionUpdateRequest, BindingResult bindingResult) throws ValidationErrorsException, DatabaseNotFoundException, NoAddDatabaseException {
        validationErrorsService.validation(bindingResult);
        return ResponseEntity.ok(new MessageResponse(userSettingsService.updateDescription(descriptionUpdateRequest)));
    }

    @PostMapping("/update/password")
    public ResponseEntity<MessageResponse> updatePassword(@RequestBody @Valid PasswordUpdateRequest passwordUpdateRequest,BindingResult bindingResult) throws ValidationErrorsException, DatabaseNotFoundException, NoAddDatabaseException, PasswordUpdateException {
        validationErrorsService.validation(bindingResult);
